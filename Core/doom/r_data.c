...
void R_InitTextures(void)
{
    ...
    texpatch_t *patch;
#else
    volatile maptexture_t *mtexture;
    volatile texture_t *texture;
    volatile mappatch_t *mpatch;
    volatile texpatch_t *patch;
#endif
...
#else
        for (uint8_t b = 0; b < sizeof(texture->name); b++)
        {   
            uint8_t* ptr1 = (uint8_t*)texture->name+b;
            uint8_t* ptr2 = (uint8_t*)mtexture->name+b;
            *ptr1 = *ptr2;         
        }
#endif
