...
static void ClearChannel(int channel)
{
...
static int I_stm32_StartSound(sfxinfo_t *sfxinfo, int channel, int vol, int sep, int pitch)
{
    ...
    {
        printf("I_stm32_StartSound: Error caching SFX\n");
        return false;
    }

    // set separation, etc.

    I_stm32_UpdateSoundParams(channel, vol, sep);
...
static boolean I_stm32_SoundIsPlaying(int channel)
{
    ...
    return channels[channel].ptr != NULL;
}
...
{
    printf("TODO: I_stm32_PrecacheSounds\n");
}
