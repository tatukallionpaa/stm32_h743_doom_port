...
#define BUFFER_SLICE_SAMPLES ((2 * I2S_AUDIO_SAMPLE_RATE * BUFFER_SLICE_DUR_MS) / 1000)
//#define BUFFER_SLICE_SAMPLES 2200
#define BUFFER_SLICES 5
#define BUFFER_TOTAL_SIZE (BUFFER_SLICE_SAMPLES * BUFFER_SLICES)
